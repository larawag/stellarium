...
void Planet::drawSphere(StelPainter* painter, float screenSz, bool drawOnlyRing)
{
	...
	unsigned int nb_facet = qBound(10u, static_cast<unsigned int>(screenSz * 40.f/50.f), 100u);	// 40 facets for 1024 pixels diameter on screen
